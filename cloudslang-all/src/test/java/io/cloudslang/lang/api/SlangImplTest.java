...
public class SlangImplTest {
    ...
    public void testLaunchOperation() throws IOException {
        ...
        Mockito.when(mockSlang.compileAndRun(any(SlangSource.class), anySetOf(SlangSource.class), anyMapOf(String.class, Serializable.class), anyMapOf(String.class, String.class))).thenCallRealMethod();
        Long id = mockSlang.compileAndRun(tempFile, new HashSet<SlangSource>(), new HashMap<String, Serializable>(), new HashMap<String, String>());
        Assert.assertNotNull(id);
        Mockito.verify(mockSlang).run(emptyCompilationArtifact, new HashMap<String, Serializable>(), new HashMap<String, String>());
    }
    ...
    public void testLaunch() throws IOException {
        ...
        Long id = mockSlang.compileAndRun(tempFile, new HashSet<SlangSource>(), new HashMap<String, Serializable>(), new HashMap<String, String>());
        Assert.assertNotNull(id);
        Mockito.verify(mockSlang).compileAndRun(tempFile, new HashSet<SlangSource>(), new HashMap<String, Serializable>(), new HashMap<String, String>());
    }
