...
1. Download the cslang zip from [here](https://github.com/CloudSlang/cloud-slang/releases/download/cloudslang-0.7.4/cslang-cli.zip). (For the latest snapshot, download form [here](https://github.com/CloudSlang/cloud-slang/releases/latest))
2. Unzip it.
