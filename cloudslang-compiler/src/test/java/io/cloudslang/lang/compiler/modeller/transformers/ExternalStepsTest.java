...
@ContextConfiguration(classes = {ExternalStepsTest.Config.class, SlangCompilerSpringConfig.class})
public class ExternalStepsTest extends TransformersTestParent {
    ...
    public void init() throws URISyntaxException {
        URL resource = getClass().getResource("/flow_with_external_steps.yaml");
