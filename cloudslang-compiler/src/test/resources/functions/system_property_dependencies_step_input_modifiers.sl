...
flow:
  name: system_property_dependencies_step_input_modifiers
  inputs:
    - input1
    ...
    - Step1:
        do:
          ops.system_property_dependencies_op:
            ...
            - input3:
                value: ${get_sp('step.input.prop1')}
            - input4:
                value: ${get_sp('step.input.prop2', 'default_str')}
                sensitive: false
        ...
        loop:
          ...
          do:
            ops.system_property_dependencies_op:
              - input1
              - input2:
                  value: "get_sp('for.input.i_am_no_property')"
                  sensitive: true
              - input3:
                  value: ${get_sp('for.input.prop1')}
                  sensitive: false
