...
public class ParserExceptionHandler {
    ...
    public static String CANNOT_CREATE_PROPERTY_ERROR = "Cannot create property";
    public static String KEY_VALUE_PAIR_MISSING_OR_INDENTATION_PROBLEM_MSG = "Probably did not provide (key: value) pair or missing space after colon(:). Also check that everything is indented properly";
    public static String MAPPING_VALUES_NOT_ALLOWED_HERE_ERROR = "mapping values are not allowed here";
    public static String SCANNING_A_SIMPLE_KEY_ERROR = "while scanning a simple key";
    public static String UNABLE_TO_FIND_PROPERTY_ERROR = "Unable to find property";
    public static String MAP_CONSTRUCTOR_NOT_FOUND_ERROR = "No single argument constructor found for interface java.util.Map";
    public static String TRUNCATION_BEGINNING = "Unable";
    public static String TRUNCATION_END = "on class";
