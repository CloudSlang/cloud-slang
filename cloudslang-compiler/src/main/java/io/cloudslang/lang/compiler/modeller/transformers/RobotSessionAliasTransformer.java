...
public class RobotSessionAliasTransformer extends AbstractInOutForTransformer
        implements Transformer<String, RobotSessionAliasStatement> {

    @Override
    public TransformModellingResult<RobotSessionAliasStatement> transform(String rawData) {
    ...
    public TransformModellingResult<RobotSessionAliasStatement> transform(String rawData,
        ...
        RobotSessionAliasStatement robotGroupStatement;
        ...
        if (expression != null) {
            robotGroupStatement = new RobotSessionAliasStatement(expression,
                    dependencyAccumulator.getFunctionDependencies(),
                    dependencyAccumulator.getSystemPropertyDependencies());
        } else {
            robotGroupStatement = new RobotSessionAliasStatement(rawData, null, null);
        }
    ...
    public String keyToTransform() {
        return SlangTextualKeys.ROBOT_SESSION_ALIAS;
    }
