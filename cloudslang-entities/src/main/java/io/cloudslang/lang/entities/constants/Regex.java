...
public class Regex {
    ...
    public static final String SYSTEM_PROPERTY_REGEX_WITHOUT_QUOTES = "get_sp\\(\\s*" + NAMESPACE_CHARS + "\\s*\\)";
    ...
    public static final String SYSTEM_PROPERTY_REGEX_WITH_DEFAULT_DOUBLE_QUOTE = "get_sp\\(\\s*\"" + NAMESPACE_CHARS +
            "\"\\s*,\\s*(.+?)\\)";
    public static final String SYSTEM_PROPERTY_REGEX_WITH_DEFAULT_WITHOUT_QUOTES = "get_sp\\(\\s*" + NAMESPACE_CHARS +
            "\\s*,\\s*(.+?)\\)";
    // match get() function
