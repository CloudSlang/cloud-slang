...
#        sensitive: true
  ...
  python_action:
    script: |
      print input_no_value
      print input_no_value_sensitive
      print input_get_input_no_value
      print input_get_input_no_value_sensitive
      print input_get_sensitive_input_no_value
      print input_get_sensitive_input_no_value_sensitive
      print input_python_get_input_no_value
      print input_python_get_input_no_value_sensitive
      print input_python_get_sensitive_input_no_value
      print input_python_get_sensitive_input_no_value_sensitive
      print input_with_value
      print input_with_value_sensitive
      print input_get_input_with_value
      print input_get_input_with_value_sensitive
      print input_get_sensitive_input_with_value
      print input_get_sensitive_input_with_value_sensitive
      print input_python_get_input_with_value
      print input_python_get_input_with_value_sensitive
      print input_python_get_sensitive_input_with_value
      print input_python_get_sensitive_input_with_value_sensitive
      print input_system_property
      print input_system_property_sensitive
      print input_get_input_system_property
      print input_get_input_system_property_sensitive
      print input_get_sensitive_input_system_property
      print input_get_sensitive_input_system_property_sensitive
      print input_python_get_input_system_property
      print input_python_get_input_system_property_sensitive
      print input_python_get_sensitive_input_system_property
      print input_python_get_sensitive_input_system_property_sensitive
      print input_authorized_keys_path
      print input_authorized_keys_path_sensitive
      print input_scp_host_port
      print input_scp_host_port_sensitive
      print input_not_overridable
      print input_not_overridable_sensitive
      print input_overridable_hi1
      print input_overridable_hi1_sensitive
      print input_overridable_hi2
      ...
      print input_x_copy
      print input_x_copy_sensitive
      print input_sensitive_x_copy
      print input_sensitive_x_copy_sensitive
      print input_concat_x
      print input_concat_x_sensitive
      print input_sensitive_concat_x
      print input_sensitive_concat_x_sensitive
      print input_y
      print input_y_sensitive
      print input_concat_y
      print input_concat_y_sensitive
      print input_sensitive_concat_y
      print input_sensitive_concat_y_sensitive
      print input_concat_ab
      print input_concat_ab_sensitive
      print input_concat_xy
      print input_concat_xy_sensitive
      print input_concat_x_sensitive_y
      print input_concat_x_sensitive_y_sensitive
      print input_concat_x_y_sensitive
      print input_concat_x_y_sensitive_sensitive
      print input_concat_x_sensitive_y_sensitive
      print input_concat_x_sensitive_y_sensitive_sensitive
      print input_concat_x_folded
      print input_concat_x_folded_sensitive
      print input_sensitive_concat_x_folded
      print input_sensitive_concat_x_folded_sensitive
      print input_concat_x_folded_copy
      print input_concat_x_folded_copy_sensitive
      print input_sensitive_concat_x_folded_copy
      print input_sensitive_concat_x_folded_sensitive
      print input_expression_characters
      print input_expression_characters_sensitive
      print input_sensitive_expression_characters
