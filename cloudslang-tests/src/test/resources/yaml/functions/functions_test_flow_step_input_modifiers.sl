...
flow:
  name: functions_test_flow_step_input_modifiers
  inputs:
    - input1:
        default: "value1"
        private: true
    ...
    - Step1:
        do:
          ops.functions_test_op:
            - exist
            - input_3:
                value: ${get_sp('a.b.c.i_don_t_exist')}
            - input_4:
                value: ${get_sp('a.b.c.i_don_t_exist', 'default_str')}
                sensitive: false
            - input_5: ${get_sp('a.b.c.host')}
            - input_6:
                value: ${get_sp('a.b.c.host', 'default_str')}
                sensitive: false
            - input_7: ${get('i_don_exist', get_sp('a.b.c.host'))}
            - input_8: ${get('exist', get_sp('a.b.c.host'))}
            - input_9: ${get(    'i_don_exist',        get_sp('a.b.c.host')       )}
            ...
            - value_propagate_input:
                value: ${ value_propagate_input + get_sp('propagate.step.argument') }
                sensitive: true
            - input_12: ${get_sp('chars-b.c-hyphen')}
            - input_13: ${get_sp('chars-b.c-hyphen', 'default_str')}
            - input_14: ${get_sp("a.b.c.host")}
            ...
            - input_17:
                value: ${check_empty(get('i_dont_exist'), 'default_str')}
        publish:
          - output1_safe
          - output2_safe
          - output_same_name
